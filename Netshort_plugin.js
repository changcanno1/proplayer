...
// Tạo List phim ở menu Home
  function getHomeSections() {
      localStorage.clear();
      return JSON.stringify([
           {"slug": "/vi/drama/all-plots","title": "Phim Mới","type": "Grid"}
      ]);
  }
  ...
  function getLISTmenu() {
    try{
      return `[{
    "link": "/vi/drama/all-plots",
    "name": "Phim Mới"
}, {
    "link": "/vi/drama/Ngh%E1%BB%8Bch%2520c%E1%BA%A3nh-1984208314792402961",
    "name": "Nghịch cảnh"
}, {
    "link": "/vi/drama/K%E1%BB%8Bch%2520t%C3%ADnh-1983832091029397515",
    "name": "Kịch tính"
}, {
    "link": "/vi/drama/C%E1%BB%95%2520%C4%91%E1%BA%A1i-1983832036533420044",
    "name": "Cổ đại"
}, {
    "link": "/vi/drama/Ng%E1%BB%8Dt%2520s%E1%BB%A7ng-1983832091151032332",
    "name": "Ngọt sủng"
}, {
    "link": "/vi/drama/B%C3%A1o%2520th%C3%B9-1983832036302733325",
    "name": "Báo thù"
}, {
    "link": "/vi/drama/Ng%C6%B0%E1%BB%A3c%2520t%C3%A2m-1983832091079729160",
    "name": "Ngược tâm"
}, {
    "link": "/vi/drama/Trinh%2520th%C3%A1m-1983832092497403916",
    "name": "Trinh thám"
}, {
    "link": "/vi/drama/Tr%C3%B9ng%2520sinh-1983832036273373197",
    "name": "Trùng sinh"
}, {
    "link": "/vi/drama/C%C6%B0%E1%BB%9Bi%2520tr%C6%B0%E1%BB%9Bc%2520y%C3%AAu%2520sau-1983832091939561484",
    "name": "Cưới trước yêu sau"
}, {
    "link": "/vi/drama/%C4%90%E1%BA%A1o%2520%C4%91%E1%BB%A9c%2520gia%2520%C4%91%C3%ACnh-1983832092405129228",
    "name": "Đạo đức gia đình"
}]`;
    } catch(e){
      log("getLISTmenu[err]:\n " + e);
      return `[
...
function parseListResponse(html, url) {
    ...
    try {
        var $doc = _$(html);
        var items = [];
        $doc.find(".video-list-item").each(function() {
            var id = this.find("a").attr("href");
            if (id.indexOf("http") == -1) {
                id = BASEURL + id;
            }
            var name = this.find(".text-white a").text().trim();
            
            // Regex: Nhóm 1 là tùy chọn (optional), Nhóm 2 lấy phần còn lại
            const regex = /^(?:\((.*?)\)\s*)?(.*)$/i;
            
            const [, group1 = "", group2 = name] = name.match(regex) || [];
            
            var title = decodeHTMLtext(group2);
...
function parseMovieDetail(html, url) {
    ...
    try {
        ...
        var title = decodeHTMLtext($doc.find('meta[property="og:title"]').attr("content")) || "";
        var originName = title;
        var description = decodeHTMLtext($doc.find("h2:content('Tóm|tắt')").next().text()) || "";
        var director = "";
        var casts = "";
        var category = "";
        var duration = "";

        // --- SỬA LỖI LẤY SỐ TẬP TẠI ĐÂY ---
        var epiMatch = html.match(/numberOfEpisodes[^0-9]+(\d+)/)
        var maxEpi = epiMatch ? parseInt(epiMatch[1], 10) : 1;
