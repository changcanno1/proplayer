...
// Tích hợp Fix lỗi ép Native Player trên iOS
// =============================================================================
...
function getManifest() {
    return JSON.stringify({
        "id": "phimngan_net",
        "name": "PhimNgan.Net",
        "description": "Bản Webview Gốc: Load siêu tốc, ép video dọc, xóa rác giao diện (Fix lỗi iOS Native).",
        "version": "1.9.6",
        "baseUrl": BASEURL,
        ...
        "type": "shortfilm",                  
        "layoutType": "VERTICAL",             
        // [QUAN TRỌNG] Vô hiệu hóa hoàn toàn Sniffer, sử dụng Webview Gốc.
        // Mẹo: Nếu "embed" vẫn bị lỗi trên app của bạn, hãy thử đổi thành "webview"
        "playerType": "embed" 
    });
}
