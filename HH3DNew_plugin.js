...
function parseMovieDetail(htmlContent, url) {
    try {
        ...
        $child.find("a").each(function() {
            ...
            // --- BẮT ĐẦU SỬA: Bắt chính xác tập cuối bằng Regex ---
...
function parseDetailResponse(html, url) {
    try {
        ...
        // --- BẮT ĐẦU SỬA: Giữ nguyên cơ chế quét _$, chỉ bổ sung quét dự phòng data-src an toàn ---
        ...
        // --- BẮT ĐẦU SỬA: Loại bỏ .replace() làm hỏng link CDN của server ---
