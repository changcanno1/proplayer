// =============================================================================
// CẤU HÌNH TÊN MIỀN (SỬA NHANH Ở ĐÂY KHI WEB THAY ĐỔI)
// =============================================================================
...
function parseMovieDetail(htmlContent, url) {
    try {
        ...
        $child.find("a").each(function() {
            ...
            // Khắc phục triệt để lỗi sót tập cuối bằng Regex quét trực tiếp block HTML của tab
...
function parseDetailResponse(html, url) {
    try {
        ...
        // Vòng lọc bổ sung: Quét toàn bộ thuộc tính data-src từ các nút bấm phát video thực tế (ví dụ: #list_sv)
        ...
        // Dự phòng quét toàn bộ data-src nếu không tìm thấy qua thẻ a
        if (allLink.length === 0) {
