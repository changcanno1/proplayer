...
function parseListResponse(html, $url) {
    try {
        ...
        _$(html).find("article[class*='card']").each(function() {
            ...
            if(!title) title = decodeHTMLtext(this.attr("data-search-title"));
...
function parseMovieDetail(html, url) {
    try {
        ...
        var ldirec = "", lactor = "", lduran = "", status = "", category = "", episode_current = "";
...
function parseEmbedResponse(html, url, datasend) {
    try {
        if (!html) throw new Error("Dữ liệu HTML/JSON nhận về bị rỗng");
        ...
        if (!link) throw new Error("Không tìm thấy đường dẫn video trong phản hồi");
